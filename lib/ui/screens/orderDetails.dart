...
import 'package:shop_delivery/architecture/orderDetails.dart/orderDetails_bloc.dart';
...
class _OrderDetailState extends State<OrderDetail> {
  OrderDetailBloc _myOrderBloc = OrderDetailBloc();
  User user;
  int sum = 0;
  int errorVala = 1;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<OrderDetails>(
          stream: _myOrderBloc.orderDetailBloc.stream,
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: <Widget>[
                              Text('Sale no.  ' + data.data.data[index].id),
                              Row(
                                children: [
                                  Icon(
                                    Icons.table_chart,
                                  ...
                                  Text('  ' + data.data.data[index].id),
                                ],
                              )
                            ],
                          ),
                          Text('Amount ${data.data.data[index].id}'),
                          Row(
